...
<body>
    ...
    <div align="right">
        <a href="/cetak_total" class="btn btn-primary mb-3">Cetak Laporan Stok</a>
        <a href="/cetak_stok" class="btn btn-primary mb-3">Cetak Barang</a>
    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button class="btn btn-primary btn-sm" onclick="formTambah(<?php echo e($stok->id); ?>)">Tambah</button>
                </td>
            </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\stok_udwangiagung_fix\resources\views//stok/stok_barang.blade.php ENDPATH**/ ?>
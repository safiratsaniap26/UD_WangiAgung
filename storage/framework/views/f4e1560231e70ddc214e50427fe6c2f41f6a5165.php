...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo e(asset('template/landing/materialdesignicons.min.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('template/landing/owl.carousel.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('template/landing/owl.theme.default.min.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('template/landing/aos.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('template/landing/jquery.flipster.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('template/landing/style.css')); ?>">
	...
	<body data-spy="scroll" data-target=".navbar" data-offset="50">
					...
					<div class="row" data-aos="fade-up">
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="<?php echo e(asset('image/layangpeda.png')); ?>" alt="integrated-marketing" data-aos="zoom-in">
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box"   data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="<?php echo e(asset('image/grago.png')); ?>"  alt="design-development" data-aos="zoom-in">
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="<?php echo e(asset('image/teri.png')); ?>" alt="digital-strategy" data-aos="zoom-in">
								<h6 class="mb-3 mt-4 font-weight-medium" style="color: #dee2e6">
		...
		<script src="<?php echo e(asset('template/landing/vendor.bundle.base.js')); ?>"></script>
		<script src="<?php echo e(asset('template/landing/owl.carousel.js')); ?>"></script>
		<script src="<?php echo e(asset('template/landing/aos.js')); ?>"></script>
		<script src="<?php echo e(asset('template/landing/jquery.flipster.min.js')); ?>"></script>
	
		<script src="<?php echo e(asset('template/landing/template.js')); ?>"></script>

	</body>
</html><?php /**PATH D:\Teknik Informatika\Web Programing\application\wangi-agung-web\resources\views/landingpage.blade.php ENDPATH**/ ?>
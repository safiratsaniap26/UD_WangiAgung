        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-primary shadow-sm">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <?php else: ?>
                            <li class="nav-item">
                                <a class="nav-link text-light active" href="/dashboard/dashboard"><?php echo e(__('Dashboard')); ?></a>
                            </li> 
                            <li class="nav-item">
                                <a class="nav-link text-light" href="/data_transaksi/data_transaksi"><?php echo e(__('Data Transaksi')); ?></a>
                            </li>  
                            <li class="nav-item">
...
<?php /**PATH D:\Teknik Informatika\Web Programing\application\wangi-agung-web\resources\views/layouts/app.blade.php ENDPATH**/ ?>
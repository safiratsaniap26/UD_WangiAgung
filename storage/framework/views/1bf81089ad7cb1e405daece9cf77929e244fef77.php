                    ...
                    <div class="modal fade" id="hapus<?php echo e($s->id); ?>" tabindex="-1" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                                Yakin hapus user <?php echo e($s->name); ?> ?
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aditasyhari/Project Laravel/stok_barang_laravel-main/resources/views/sekertaris/index.blade.php ENDPATH**/ ?>
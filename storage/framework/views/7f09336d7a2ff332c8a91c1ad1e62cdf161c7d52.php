        ...
        <div class="box box-widget my-3">
            <div class="box-body">
                <div align="right">
                    ...
                    <h2><b><span id="total_pembelian" style="font-size:42pt">Rp 0</span></b></h2>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function tambah() {
        ...
        if(jumlah > jumlah_barang) {
            ...
            pembelian_total.innerHTML = formatRupiah(total_pembelian);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Teknik Informatika\Web Programing\application\wangi-agung-web\resources\views/kasir/kasir.blade.php ENDPATH**/ ?>